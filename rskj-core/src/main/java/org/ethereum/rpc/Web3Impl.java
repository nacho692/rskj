...
public class Web3Impl implements Web3 {
    ...
    public String eth_coinbase() {
        String s = null;
        try {
            s = TypeConverter.toUnformattedJsonHex(minerServer.getCoinbaseAddress().getBytes());
            return s;
        } finally {
            if (logger.isDebugEnabled()) {
    ...
    public String eth_getStorageAt(String address, String storageIdx, String blockId) {
        ...
        try {
            ...
            DataWord storageValue = accountInformationProvider.
                    getStorageValue(addr, DataWord.valueOf(TypeConverter.stringHexToByteArray(storageIdx)));
            if (storageValue != null) {
                s = TypeConverter.toUnformattedJsonHex(storageValue.getData());
                return s;
            } else {
                return null;
            }
    ...
    public static Block getBlockByNumberOrStr(String bnOrId, Blockchain blockchain) throws Exception {
        ...
        if ("latest".equals(bnOrId)) {
            ...
            long bn = TypeConverter.JSonHexToLong(bnOrId);
    ...
    @Override
    public String eth_getCode(String address, String blockId) {
        if (blockId == null) {
            throw new NullPointerException();
        }
        ...
        try {
            ...
            if(accountInformationProvider != null) {
                ...
                s = TypeConverter.toUnformattedJsonHex(code);
            }
    ...
    private BlockInformationResult getBlockInformationResult(BlockInformation blockInformation) {
    ...
    public TransactionResultDTO eth_getTransactionByHash(String transactionHash) throws Exception {
        ...
        try {
            Keccak256 txHash = new Keccak256(TypeConverter.stringHexToByteArray(transactionHash));
            Block block = null;
    ...
    public String eth_newFilter(FilterRequest fr) throws Exception {
        ...
        try {
            ...
            str = TypeConverter.toQuantityJsonHex(id);
            return str;
        } finally {
            if (logger.isDebugEnabled()) {
    ...
    public String eth_newBlockFilter() {
        ...
        try {
            ...
            s = TypeConverter.toQuantityJsonHex(id);
            return s;
        } finally {
            if (logger.isDebugEnabled()) {
    ...
    public boolean eth_uninstallFilter(String id) {
        ...
        try {
            ...
            return filterManager.removeFilter(TypeConverter.stringHexToBigInteger(id).intValue());
        } finally {
            if (logger.isDebugEnabled()) {
    ...
    private Object[] getFilterEvents(String id, boolean newevents) {
        return this.filterManager.getFilterEvents(TypeConverter.stringHexToBigInteger(id).intValue(), newevents);
    }
